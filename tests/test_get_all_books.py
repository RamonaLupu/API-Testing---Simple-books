...
class TestBooks:
    ...
    def test_get_all_bookc_type_fiction(self):
    ...
    def test_get_all_bookc_type_non_fiction(self):
    ...
    def test_get_all_books_type_invalid(self):
        ...
        assert r.json()["error"] == "Invalid value for query parameter 'type'. Must be one of: fiction, non-fiction.", f"Error is not correct!{r.json()['error']}"
    ...
    def test_all_books_type_fiction_limit_2(self):
